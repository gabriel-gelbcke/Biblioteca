            ...
            <div className="container-fluid">
                ...
                <div className="collapse navbar-collapse" id="navbarNavAltMarkup">
                    <div className="navbar-nav">
                        ...
                        <Link className='link1' to="/usuarios/listar"><a className="nav-link active" href="#">Usuarios</a></Link>
                        <Link className='link1' to="/emprestimos/listar"><a className="nav-link active" href="#">Emprestimos</a></Link>
                    </div>
                </div>
            </div>
        </nav>
