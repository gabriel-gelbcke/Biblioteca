    ...
    return (
        <div className='listarLivros'>
            ...
            <div className='TituloListar'>
                ...
                <Link className='link1' to="/emprestimos/cadastrar"><a className='link2'>CADASTRAR</a></Link>
                <Link className='link1' to="/emprestimos/excluir"><a className='link1'>EXCLUIR</a></Link>
            </div>
            ...
            <div className="content-livros">
                <div className="box-livros">
                    <table className="table table-striped table-dark">
                        ...
                        <tbody>
                                <tr>
                                    <td><input className="form-control" placeholder="Id do livro para excluir" type="text" id="id" name="id" value={id} onChange={handleInputChange} /></td>
...
export default EmprestimoExcluir;
